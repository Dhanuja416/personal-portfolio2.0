            ...
            <div className="space-y-8">
              ...
              >
                ...
                <div className="flex space-x-4">
                  <a href="https://www.linkedin.com/in/dhanuja-surasingha-0a03a7260/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-rose-500 text-white font-bold py-2 px-5 rounded-lg shadow-lg transform transition-all duration-300 hover:scale-[1.05] hover:bg-rose-600">
